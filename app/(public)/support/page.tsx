  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-white text-gray-900 pb-[calc(3rem+var(--safe-bottom))]">
      <div className="mx-auto max-w-xl px-4 pt-8">
        ...
        <h1 className="mt-1 text-[2rem] font-black leading-tight tracking-tight">運営について</h1>
      ...
      <div className="mx-auto mt-8 max-w-xl px-4">
        ...
        {/* 運営費 */}
        <section className="mt-4 rounded-2xl border border-amber-100 bg-white p-5 shadow-sm">
