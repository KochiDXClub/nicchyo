        ...
        <div className="mt-14 space-y-14">
          <Section number={1} title="お預かりしている情報">
            ...
            <Detail term="AI へのご相談の記録（自動）">
              <strong className="font-semibold text-nicchyo-ink">
                ご相談の内容そのものは保存しておりません。
              </strong>
              お預かりするのは、そこから取り出したことば、ご相談の種類、
              「会場のあたりにいらっしゃるか」の区分、ブラウザごとの識別子で、
              どのようなお困りごとが多いかを知るために用います。
              接続元の IP アドレスも保存しておりません。
              なお、お写真を添えてご相談いただいた場合、お写真そのものは保存しておりません。
              回答が役に立たなかったとお知らせいただく際に、「このときのやりとりも送る」を
              お選びになった場合だけ、そのときのご質問と回答を
              お名前・電話番号・メールアドレスとおぼしき部分を伏せたうえでお預かりし、
              受け答えの改善に用います。お選びにならなければ、評価とご意見の文だけが届きます。
            </Detail>
