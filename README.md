...
*   **ショップバナー**: 店舗の最新情報を表示。詳細を書きすぎず、店主に話しかけるきっかけを作ります。
*   **追加機能・「近況」**：出店者がインスタのように写真を投稿し、来訪者が閲覧できる機能をメイン機能として実装。1週間ごとに情報を更新することで、リアルタイム性を演出します。


### 補助機能
*   **バッグ機能（買い物リスト）**: 気になる商品をメモし、記憶の負担を減らして目の前の体験に集中させる機能。
*   ~~**出店状況の共有**: 旧「ことづて」機能を簡素化。来場者が「今、店が開いているか」を投票・共有する機能。~~(廃止)
...
.env.exampleにテンプレートを置いているので、それをコピーして、ご活用ください。
