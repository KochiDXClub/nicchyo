 ...
 * アクセス推移・滞在時間・URL別集計
 *
 * もともと管理者ダッシュボードに置かれていたが、ダッシュボードは
 * 「今やること」を示す入口に役割を絞ったため、分析はこちらへ集約した。
 * アナリティクスページから読み込むサーバーコンポーネント。
 */
...
export async function TrafficOverview() {
  ...
  const visitorDailyDurationMap = buildVisitorDailyDurationMap(weeklyDurationRows);
