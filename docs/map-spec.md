...
※ 従来の独立した「ことづてページ」は廃止されました。マップ上のショップバナーまたは詳細パネルに統合されます。
...
独立ページ（kotodute）が廃止され、map機能に取り込まれたことを意識してください。

3. データスキーマ設計（TypeScript 型）

ショップバナーに統合される「ことづて（ステータス）」の型を定義してください。
...
ショップのステータス更新のトリガーを含めた、MapPage の状態管理を設計してください。
